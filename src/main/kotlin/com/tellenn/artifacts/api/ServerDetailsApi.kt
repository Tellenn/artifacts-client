...
import com.tellenn.artifacts.api.models.StatusResponseSchema
...
class ServerDetailsApi(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    suspend fun getServerDetailsGet() : StatusResponseSchema = withContext(Dispatchers.IO) {
        val localVarResponse = getServerDetailsGetWithHttpInfo()

        return@withContext when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as StatusResponseSchema
    ...
    suspend fun getServerDetailsGetWithHttpInfo() : ApiResponse<StatusResponseSchema?> = withContext(Dispatchers.IO) {
        val localVariableConfig = getServerDetailsGetRequestConfig()

        return@withContext request<Unit, StatusResponseSchema>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation getServerDetailsGet
     *
     * @return RequestConfig
     */
    fun getServerDetailsGetRequestConfig() : RequestConfig<Unit> {
